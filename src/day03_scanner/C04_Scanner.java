...
public class C04_Scanner {
	...
	public static void main(String[] args) {
		...
		//primitive data turleri sadece deger icerirken non-primitive data turleri degerin yaninda method'lar barindirir
		// scan. dedigimizde kullanabilecegimiz bu method'lari gorebiliriz
		
		// 2.adim kullaniciya ne istedigimizi soylemek
		System.out.println("Lutfen Isminizi Giriniz" );
		
		// 3.adim kullanicinin girdigi degeri variable'a atamaliyiz
