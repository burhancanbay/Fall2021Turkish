...
public class C07_Yarisma {
	...
	public static void main(String[] args) {
		// Soru : For loop ile 1000 defa bir islem yapalim. Oncesinde ve sonrasinda zamani kontrol edip StringBuilder ve 
		...
		sb.trimToSize(); // capasity'i length boyutuna indirir
