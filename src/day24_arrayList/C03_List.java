...
public class C03_List {
	...
	public static void main(String[] args) {
		// Verilen bir array'den istenen degere sahip elementleri silip
				...
				System.out.println("list olarak : "+gecici); // list olarak istenmeyen elemanlar haric tum elemanlari goruruz
				// sonucu Array olarak gormek istiyorsak lisredekileri yeni array'e ekleyebiliriz
