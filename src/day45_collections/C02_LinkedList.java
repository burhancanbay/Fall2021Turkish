...
public class C02_LinkedList {
	...
	public static void main(String[] args) {
		...
		// LinkedList class'inda override ettigimiz icin List interface olmasina ragmen List method'larini kullanabildik
		...
		ll3.add(5);
		ll3.add(7);
		ll3.addLast(20); // // data turu Deque secilince Deque interface'inden gelen method'lari kullanabildik
