...
public class C01_Array {
	...
	public static void main(String[] args) {
		// verilen bir array'dan istenen degere sahip elementleri silip kalani yeni bir
		// array olarak kaydedin
		...
		// bu soruda istenen elementi sildigimizde geriye element kaliyor bulmamiz lazim
		// silinecek element adedini bulalim
